 ...
 */
final class Version20221107174541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP user_id, CHANGE title title VARCHAR(50) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE articles ADD user_id INT NOT NULL, CHANGE title title VARCHAR(100) NOT NULL');
