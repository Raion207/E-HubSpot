 ...
 */
final class Version20221107175520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE keywords CHANGE word keyword VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE keywords CHANGE keyword word VARCHAR(50) NOT NULL');
    }
}
